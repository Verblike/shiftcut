...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/lt-kicker-name.mp4" poster="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/lt-kicker-name.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx shiftcut add lt-kicker-name
```
...
| File | Target | Type |
| --- | --- | --- |
| `lt-kicker-name.html` | `compositions/lt-kicker-name.html` | shiftcut:composition |
