...
```bash Terminal
npx shiftcut add thermal-distortion
```
...
| File | Target | Type |
| --- | --- | --- |
| `thermal-distortion.html` | `compositions/thermal-distortion.html` | shiftcut:composition |
