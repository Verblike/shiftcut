...
```bash Terminal
npx shiftcut add gravitational-lens
```
...
| File | Target | Type |
| --- | --- | --- |
| `gravitational-lens.html` | `compositions/gravitational-lens.html` | shiftcut:composition |
