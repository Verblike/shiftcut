...
```bash Terminal
npx shiftcut add nyc-paris-flight
```
...
| File | Target | Type |
| --- | --- | --- |
| `nyc-paris-flight.html` | `compositions/nyc-paris-flight.html` | shiftcut:composition |
| `assets/map-nyc-paris.png` | `assets/map-nyc-paris.png` | shiftcut:asset |
| `assets/sfx-mix.wav` | `assets/sfx-mix.wav` | shiftcut:asset |
