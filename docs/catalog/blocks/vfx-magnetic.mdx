...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/vfx-magnetic.mp4" poster="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/vfx-magnetic.png" autoPlay muted loop playsInline />
...
| File | Target | Type |
| --- | --- | --- |
| `vfx-magnetic.html` | `compositions/vfx-magnetic.html` | shiftcut:composition |
