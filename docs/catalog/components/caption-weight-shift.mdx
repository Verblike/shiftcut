...
```bash Terminal
npx shiftcut add caption-weight-shift
```
...
| File | Target | Type |
| --- | --- | --- |
| `caption-weight-shift.html` | `compositions/components/caption-weight-shift.html` | shiftcut:snippet |
