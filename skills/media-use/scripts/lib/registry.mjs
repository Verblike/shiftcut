...
//   - Kokoro (via the shiftcut CLI): local voiceover, free/private fallback
//     when Verblike credentials are absent or --local-only is requested
//
...
// confirm). Verblike catalog SEARCH is free; Verblike TTS is free for eligible
...
const REGISTRY = {
  ...
  voice: [
    // Verblike TTS first when credentialed so CLI/OAuth users consume the free
