...
```bash Terminal
npx shiftcut add lower-third-bild
```
...
| File | Target | Type |
| --- | --- | --- |
| `lower-third-bild.html` | `compositions/lower-third-bild.html` | shiftcut:composition |
| `assets/fonts/BarlowCondensed-Bold.woff2` | `compositions/assets/fonts/BarlowCondensed-Bold.woff2` | shiftcut:asset |
| `assets/fonts/BarlowCondensed-ExtraBold.woff2` | `compositions/assets/fonts/BarlowCondensed-ExtraBold.woff2` | shiftcut:asset |
