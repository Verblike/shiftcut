...
```bash Terminal
npx shiftcut add caption-highlight
```
...
| File | Target | Type |
| --- | --- | --- |
| `caption-highlight.html` | `compositions/components/caption-highlight.html` | shiftcut:snippet |
