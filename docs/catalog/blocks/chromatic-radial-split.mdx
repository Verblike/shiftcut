...
```bash Terminal
npx shiftcut add chromatic-radial-split
```
...
| File | Target | Type |
| --- | --- | --- |
| `chromatic-radial-split.html` | `compositions/chromatic-radial-split.html` | shiftcut:composition |
