...
```bash Terminal
npx shiftcut add liquid-glass-widgets
```
...
| File | Target | Type |
| --- | --- | --- |
| `liquid-glass-widgets.html` | `compositions/liquid-glass-widgets.html` | shiftcut:composition |
