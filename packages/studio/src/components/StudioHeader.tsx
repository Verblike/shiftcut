...
function ShiftcutLogo() {
  return (
    <div className="flex items-center gap-2" aria-label="ShiftCut Studio">
      <svg width="24" height="24" viewBox="0 0 28 28" fill="none" aria-hidden="true">
        <rect x="2.5" y="6.5" width="14" height="15" rx="3.5" stroke="#d7d0c8" strokeWidth="2" />
        <rect x="10.5" y="2.5" width="15" height="15" rx="3.5" fill="#ff7a1a" />
        <path d="M18 6.5 14.5 13.5" stroke="#181512" strokeWidth="2" strokeLinecap="round" />
      </svg>
      <span className="text-sm font-semibold tracking-tight text-[#fff8f1]">ShiftCut</span>
      <span className="rounded-sm border border-[#5a4030] bg-[#2d2119] px-1.5 py-0.5 text-[9px] font-semibold uppercase tracking-[0.12em] text-[#ffb27a]">
        Studio
      </span>
    </div>
  );
