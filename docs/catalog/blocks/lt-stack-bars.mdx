...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/lt-stack-bars.mp4" poster="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/lt-stack-bars.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx shiftcut add lt-stack-bars
```
...
| File | Target | Type |
| --- | --- | --- |
| `lt-stack-bars.html` | `compositions/lt-stack-bars.html` | shiftcut:composition |
