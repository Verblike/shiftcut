...
```bash Terminal
npx shiftcut add parallax-zoom
```
...
| File | Target | Type |
| --- | --- | --- |
| `parallax-zoom.html` | `compositions/components/parallax-zoom.html` | shiftcut:snippet |
