...
```bash Terminal
npx shiftcut add grain-overlay
```
...
| File | Target | Type |
| --- | --- | --- |
| `grain-overlay.html` | `compositions/components/grain-overlay.html` | shiftcut:snippet |
