...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/lt-color-block.mp4" poster="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/lt-color-block.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx shiftcut add lt-color-block
```
...
| File | Target | Type |
| --- | --- | --- |
| `lt-color-block.html` | `compositions/lt-color-block.html` | shiftcut:composition |
