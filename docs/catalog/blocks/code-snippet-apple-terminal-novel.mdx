...
```bash Terminal
npx shiftcut add code-snippet-apple-terminal-novel
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-apple-terminal-novel.html` | `compositions/code-snippet-apple-terminal-novel.html` | shiftcut:composition |
