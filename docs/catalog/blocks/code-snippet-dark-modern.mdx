...
```bash Terminal
npx shiftcut add code-snippet-dark-modern
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-dark-modern.html` | `compositions/code-snippet-dark-modern.html` | shiftcut:composition |
