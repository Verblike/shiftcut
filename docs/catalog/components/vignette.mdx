...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/components/vignette.mp4" poster="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/components/vignette.png" autoPlay muted loop playsInline />
...
| File | Target | Type |
| --- | --- | --- |
| `vignette.html` | `compositions/components/vignette.html` | shiftcut:snippet |
