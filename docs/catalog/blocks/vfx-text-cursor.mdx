...
```bash Terminal
npx shiftcut add vfx-text-cursor
```
...
| File | Target | Type |
| --- | --- | --- |
| `vfx-text-cursor.html` | `compositions/vfx-text-cursor.html` | shiftcut:composition |
