...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/world-map.mp4" poster="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/world-map.png" autoPlay muted loop playsInline />
...
| File | Target | Type |
| --- | --- | --- |
| `world-map.html` | `compositions/world-map.html` | shiftcut:composition |
