...
```bash Terminal
npx shiftcut add code-snippet-apple-terminal-silver-aerogel
```
...
```bash Terminal
npx shiftcut add apple-terminal
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-apple-terminal-silver-aerogel.html` | `compositions/code-snippet-apple-terminal-silver-aerogel.html` | shiftcut:composition |
