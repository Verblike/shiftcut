...
```bash Terminal
npx shiftcut add cross-warp-morph
```
...
| File | Target | Type |
| --- | --- | --- |
| `cross-warp-morph.html` | `compositions/cross-warp-morph.html` | shiftcut:composition |
