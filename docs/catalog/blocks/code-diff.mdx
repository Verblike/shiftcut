...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/code-diff.mp4" poster="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/code-diff.png" autoPlay muted loop playsInline />
...
| File | Target | Type |
| --- | --- | --- |
| `code-diff.html` | `compositions/code-diff.html` | shiftcut:composition |
