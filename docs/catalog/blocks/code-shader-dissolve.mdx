...
```bash Terminal
npx shiftcut add code-shader-dissolve
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-shader-dissolve.html` | `compositions/code-shader-dissolve.html` | shiftcut:composition |
