...
```bash Terminal
npx shiftcut add transitions-blur
```
...
| File | Target | Type |
| --- | --- | --- |
| `transitions-blur.html` | `compositions/transitions-blur.html` | shiftcut:composition |
