...
```bash Terminal
npx shiftcut add flash-through-white
```
...
| File | Target | Type |
| --- | --- | --- |
| `flash-through-white.html` | `compositions/flash-through-white.html` | shiftcut:composition |
