---
title: Adopters
description: Organizations using ShiftCut in production or actively evaluating it.
---

The teams below are shipping with ShiftCut. If your organization uses ShiftCut — in production, in evaluation, or in a side project — we'd love to add you.

## How to add your organization

Open a pull request that adds your team to [`ADOPTERS.md`](https://github.com/Verblike/shiftcut/blob/main/ADOPTERS.md) at the repository root. The format is intentionally lightweight:

- **Organization** — your company or project name, linked to your website.
- **Contact** — a GitHub handle so other adopters can reach out.
- **How ShiftCut is used** — one sentence on the use case.
...
<CardGroup cols={2}>
  <Card title="Verblike" href="https://shiftcut.verblike.com">
    <img src="https://shiftcut.verblike.com/apple-touch-icon.png" width="48" height="48" style={{borderRadius: "10px", marginBottom: "12px"}} />

    Powers AI-generated video composition and rendering across Verblike's video product surface.
  ...
  <Card title="TanStack" href="https://tanstack.com">
    ...
    Exploring ShiftCut for short-form code demo videos and documentation.
  ...
  <Card title="OptinMonster" href="https://optinmonster.com">
    ...
    Exploring ShiftCut for marketing and product video content.
...
The Verblike team's actual launch-video sources (the ones featured in product announcements) live at [shiftcut-launches](https://github.com/Verblike/shiftcut-launches) — see [Launch Videos](/launch-videos) for the writeup.
