...
```bash Terminal
npx shiftcut add caption-kinetic-slam
```
...
| File | Target | Type |
| --- | --- | --- |
| `caption-kinetic-slam.html` | `compositions/components/caption-kinetic-slam.html` | shiftcut:snippet |
