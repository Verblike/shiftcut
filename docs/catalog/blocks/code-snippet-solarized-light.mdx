...
```bash Terminal
npx shiftcut add code-snippet-solarized-light
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-solarized-light.html` | `compositions/code-snippet-solarized-light.html` | shiftcut:composition |
