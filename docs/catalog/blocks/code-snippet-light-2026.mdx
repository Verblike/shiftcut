...
```bash Terminal
npx shiftcut add code-snippet-light-2026
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-light-2026.html` | `compositions/code-snippet-light-2026.html` | shiftcut:composition |
