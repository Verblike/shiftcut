...
Per [PR #214](https://github.com/Vadagon/shiftcut/pull/214), the
runtime adapter:
...
>
> See https://github.com/Vadagon/shiftcut/pull/214 for the full
...
{
  "rule": "r2hf/use-state",
  "message": "useState detected — Remotion compositions that drive animation via React state are not deterministic frame-capture targets in ShiftCut",
