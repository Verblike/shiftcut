...
```bash Terminal
npx shiftcut add caption-particle-burst
```
...
| File | Target | Type |
| --- | --- | --- |
| `caption-particle-burst.html` | `compositions/components/caption-particle-burst.html` | shiftcut:snippet |
