...
```bash Terminal
npx shiftcut add code-snippet-high-contrast-light
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-high-contrast-light.html` | `compositions/code-snippet-high-contrast-light.html` | shiftcut:composition |
