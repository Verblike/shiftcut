...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/us-map-bubble.mp4" poster="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/us-map-bubble.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx shiftcut add us-map-bubble
```
...
| File | Target | Type |
| --- | --- | --- |
| `us-map-bubble.html` | `compositions/us-map-bubble.html` | shiftcut:composition |
