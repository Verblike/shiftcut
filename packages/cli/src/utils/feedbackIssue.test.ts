...
import { buildIssueUrl, SHIFTCUT_REPO_URL } from "./feedbackIssue.js";
...
describe("buildIssueUrl", () => {
  const base = {
    repoUrl: SHIFTCUT_REPO_URL,
    rating: 2,
    comment: "GSAP timeline froze on seek",
    repoPublicUrl: "https://shiftcut.verblike.com/p/abc123",
  ...
  it("encodes the title and includes rating + repro URL in the body", () => {
    ...
    expect(body).toContain("https://shiftcut.verblike.com/p/abc123");
