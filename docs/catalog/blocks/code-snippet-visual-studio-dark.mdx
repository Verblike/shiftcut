...
```bash Terminal
npx shiftcut add code-snippet-visual-studio-dark
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-visual-studio-dark.html` | `compositions/code-snippet-visual-studio-dark.html` | shiftcut:composition |
