...
```bash Terminal
npx shiftcut add caption-emoji-pop
```
...
| File | Target | Type |
| --- | --- | --- |
| `caption-emoji-pop.html` | `compositions/components/caption-emoji-pop.html` | shiftcut:snippet |
