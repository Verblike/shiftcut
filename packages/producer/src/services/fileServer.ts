 ...
 * caller serves the full body with 200. The shiftcut producer's use case
 ...
 * page. The flag is read by `@shiftcut/shader-transitions`' engine-mode
 ...
 * `@shiftcut/shader-transitions` and is loaded by the composition's
 ...
 * @shiftcut/shader-transitions) are preserved through to engine query time.
 */
