...
```bash Terminal
npx shiftcut add transitions-light
```
...
| File | Target | Type |
| --- | --- | --- |
| `transitions-light.html` | `compositions/transitions-light.html` | shiftcut:composition |
