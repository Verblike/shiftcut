...
```bash Terminal
npx shiftcut add vpn-youtube-spot
```
...
| File | Target | Type |
| --- | --- | --- |
| `vpn-youtube-spot.html` | `compositions/vpn-youtube-spot.html` | shiftcut:composition |
| `assets/vpn-sfx.wav` | `assets/vpn-sfx.wav` | shiftcut:asset |
