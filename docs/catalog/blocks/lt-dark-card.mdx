...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/lt-dark-card.mp4" poster="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/lt-dark-card.png" autoPlay muted loop playsInline />
...
| File | Target | Type |
| --- | --- | --- |
| `lt-dark-card.html` | `compositions/lt-dark-card.html` | shiftcut:composition |
