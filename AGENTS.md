...
**Porting an existing composition?** `/remotion-to-shiftcut` translates a Remotion (React) video composition into ShiftCut HTML — a source migration, separate from the creation workflows above.
