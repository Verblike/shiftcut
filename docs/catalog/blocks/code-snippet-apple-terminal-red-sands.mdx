...
```bash Terminal
npx shiftcut add code-snippet-apple-terminal-red-sands
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-apple-terminal-red-sands.html` | `compositions/code-snippet-apple-terminal-red-sands.html` | shiftcut:composition |
