...
```bash Terminal
npx shiftcut add parallax-unzoom
```
...
| File | Target | Type |
| --- | --- | --- |
| `parallax-unzoom.html` | `compositions/components/parallax-unzoom.html` | shiftcut:snippet |
