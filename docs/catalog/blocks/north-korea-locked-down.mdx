...
```bash Terminal
npx shiftcut add north-korea-locked-down
```
...
| File | Target | Type |
| --- | --- | --- |
| `north-korea-locked-down.html` | `compositions/north-korea-locked-down.html` | shiftcut:composition |
| `assets/korea-map.png` | `assets/korea-map.png` | shiftcut:asset |
