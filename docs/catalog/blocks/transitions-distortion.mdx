...
```bash Terminal
npx shiftcut add transitions-distortion
```
...
| File | Target | Type |
| --- | --- | --- |
| `transitions-distortion.html` | `compositions/transitions-distortion.html` | shiftcut:composition |
