...
```bash Terminal
npx shiftcut add lt-accent-underline
```
...
| File | Target | Type |
| --- | --- | --- |
| `lt-accent-underline.html` | `compositions/lt-accent-underline.html` | shiftcut:composition |
