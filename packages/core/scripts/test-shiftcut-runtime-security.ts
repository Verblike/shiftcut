...
const ALLOWED_PATH_PREFIX = "/static/shiftcut-runtime/";
...
const allowedRuntimeFixtures = [
  "https://runtime.example.com/static/shiftcut-runtime/shiftcut.runtime.iife.js",
  "https://runtime.example.com/static/shiftcut-runtime/v2026.02.20/shiftcut.runtime.iife.js",
];

const blockedRuntimeFixtures = [
  "http://runtime.example.com/static/shiftcut-runtime/shiftcut.runtime.iife.js",
  "javascript:alert(1)",
  "data:text/javascript,alert(1)",
  "https://evil.example/static/shiftcut-runtime/shiftcut.runtime.iife.js",
  "https://runtime.example.com/static/other/shiftcut.runtime.iife.js",
  "https://runtime.example.com/static/shiftcut-runtime/shiftcut.runtime.iife.css",
];
...
console.log(
  JSON.stringify({
    event: "shiftcut_runtime_security_fixtures_verified",
