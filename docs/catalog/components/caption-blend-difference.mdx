...
```bash Terminal
npx shiftcut add caption-blend-difference
```
...
| File | Target | Type |
| --- | --- | --- |
| `caption-blend-difference.html` | `compositions/components/caption-blend-difference.html` | shiftcut:snippet |
