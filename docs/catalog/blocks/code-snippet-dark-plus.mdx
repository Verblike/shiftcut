...
```bash Terminal
npx shiftcut add code-snippet-dark-plus
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-dark-plus.html` | `compositions/code-snippet-dark-plus.html` | shiftcut:composition |
