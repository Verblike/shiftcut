...
```bash Terminal
npx shiftcut add transitions-dissolve
```
...
| File | Target | Type |
| --- | --- | --- |
| `transitions-dissolve.html` | `compositions/transitions-dissolve.html` | shiftcut:composition |
