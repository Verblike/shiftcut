...
describe("@shiftcut/core public API exports", () => {
  describe("type-related constants and utilities", () => {
    ...
    it("exports resolveResolutionFlagPair — the pair every distributed entrypoint must forward", () => {
      ...
      // (`shiftcut cloudrun render`, `shiftcut lambda render`,
      // `shiftcut lambda render-batch`). Divergent copies across those
  ...
  describe("generator exports", () => {
    it("exports shiftcut generator functions", () => {
      expect(typeof core.generateShiftcutHtml).toBe("function");
      expect(typeof core.generateGsapTimelineScript).toBe("function");
      expect(typeof core.generateShiftcutStyles).toBe("function");
    });
  });
  ...
  describe("inline-script exports", () => {
    ...
    it("exports buildShiftcutRuntimeScript", () => {
      expect(typeof core.buildShiftcutRuntimeScript).toBe("function");
    });
