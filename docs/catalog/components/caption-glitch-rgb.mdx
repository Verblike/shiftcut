...
```bash Terminal
npx shiftcut add caption-glitch-rgb
```
...
| File | Target | Type |
| --- | --- | --- |
| `caption-glitch-rgb.html` | `compositions/components/caption-glitch-rgb.html` | shiftcut:snippet |
