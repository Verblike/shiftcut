...
```bash Terminal
npx shiftcut add code-snippet-apple-terminal-grass
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-apple-terminal-grass.html` | `compositions/code-snippet-apple-terminal-grass.html` | shiftcut:composition |
