...
```bash Terminal
npx shiftcut add liquid-glass-media-controls
```
...
| File | Target | Type |
| --- | --- | --- |
| `liquid-glass-media-controls.html` | `compositions/liquid-glass-media-controls.html` | shiftcut:composition |
