...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/lt-mask-reveal.mp4" poster="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/lt-mask-reveal.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx shiftcut add lt-mask-reveal
```
...
| File | Target | Type |
| --- | --- | --- |
| `lt-mask-reveal.html` | `compositions/lt-mask-reveal.html` | shiftcut:composition |
