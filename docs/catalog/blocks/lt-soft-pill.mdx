...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/lt-soft-pill.mp4" poster="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/lt-soft-pill.png" autoPlay muted loop playsInline />
...
| File | Target | Type |
| --- | --- | --- |
| `lt-soft-pill.html` | `compositions/lt-soft-pill.html` | shiftcut:composition |
