...
```bash Terminal
npx shiftcut add code-snippet-light-modern
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-light-modern.html` | `compositions/code-snippet-light-modern.html` | shiftcut:composition |
