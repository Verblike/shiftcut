import type { ShiftCutLintFinding, ShiftCutLintResult, ShiftCutLinterOptions } from "./types";
...
export async function lintShiftCutHtml(
  html: string,
  options: ShiftCutLinterOptions = {},
 ...
 *
 * Call this after `lintShiftCutHtml()` and merge the findings.
 *
