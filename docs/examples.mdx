...
Shiftcut includes starter examples to help you scaffold compositions quickly. Each example gives you a working project with the correct [composition structure](/concepts/compositions), [data attributes](/concepts/data-attributes), and a [GSAP timeline](/guides/gsap-animation) already wired up.
...
```bash Terminal
npx shiftcut init my-video --example <name>
```
...
<div className="not-prose grid grid-cols-2 gap-4 my-6">
  <div className="tpl-card relative rounded-xl overflow-hidden bg-zinc-900 transition-transform hover:-translate-y-0.5 hover:shadow-xl">
    <video className="w-full aspect-video object-cover block" src="https://static.verblike.ai/shiftcut-oss/docs/images/templates/warm-grain.mp4" poster="https://static.verblike.ai/shiftcut-oss/docs/images/templates/warm-grain.png" muted loop playsInline preload="metadata" />
  ...
  <div className="tpl-card relative rounded-xl overflow-hidden bg-zinc-900 transition-transform hover:-translate-y-0.5 hover:shadow-xl">
    <video className="w-full aspect-video object-cover block" src="https://static.verblike.ai/shiftcut-oss/docs/images/templates/play-mode.mp4" poster="https://static.verblike.ai/shiftcut-oss/docs/images/templates/play-mode.png" muted loop playsInline preload="metadata" />
  ...
  <div className="tpl-card relative rounded-xl overflow-hidden bg-zinc-900 transition-transform hover:-translate-y-0.5 hover:shadow-xl">
    <video className="w-full aspect-video object-cover block" src="https://static.verblike.ai/shiftcut-oss/docs/images/templates/swiss-grid.mp4" poster="https://static.verblike.ai/shiftcut-oss/docs/images/templates/swiss-grid.png" muted loop playsInline preload="metadata" />
  ...
  <div className="tpl-card relative rounded-xl overflow-hidden bg-zinc-900 transition-transform hover:-translate-y-0.5 hover:shadow-xl">
    <video className="w-full aspect-video object-cover block" src="https://static.verblike.ai/shiftcut-oss/docs/images/templates/kinetic-type.mp4" poster="https://static.verblike.ai/shiftcut-oss/docs/images/templates/kinetic-type.png" muted loop playsInline preload="metadata" />
  ...
  <div className="tpl-card relative rounded-xl overflow-hidden bg-zinc-900 transition-transform hover:-translate-y-0.5 hover:shadow-xl">
    <video className="w-full aspect-video object-cover block" src="https://static.verblike.ai/shiftcut-oss/docs/images/templates/decision-tree.mp4" poster="https://static.verblike.ai/shiftcut-oss/docs/images/templates/decision-tree.png" muted loop playsInline preload="metadata" />
  ...
  <div className="tpl-card relative rounded-xl overflow-hidden bg-zinc-900 transition-transform hover:-translate-y-0.5 hover:shadow-xl">
    <video className="w-full aspect-video object-cover block" src="https://static.verblike.ai/shiftcut-oss/docs/images/templates/product-promo.mp4" poster="https://static.verblike.ai/shiftcut-oss/docs/images/templates/product-promo.png" muted loop playsInline preload="metadata" />
  ...
  <div className="tpl-card relative rounded-xl overflow-hidden bg-zinc-900 transition-transform hover:-translate-y-0.5 hover:shadow-xl">
    <video className="w-full aspect-video object-cover block" src="https://static.verblike.ai/shiftcut-oss/docs/images/templates/nyt-graph.mp4" poster="https://static.verblike.ai/shiftcut-oss/docs/images/templates/nyt-graph.png" muted loop playsInline preload="metadata" />
...
<div className="not-prose grid grid-cols-3 gap-3 my-6">
  <div className="tpl-card relative rounded-xl overflow-hidden bg-zinc-900 transition-transform hover:-translate-y-0.5 hover:shadow-xl">
    <video className="w-full object-cover block" style={{aspectRatio: "9/16"}} src="https://static.verblike.ai/shiftcut-oss/docs/images/templates/vignelli.mp4" poster="https://static.verblike.ai/shiftcut-oss/docs/images/templates/vignelli.png" muted loop playsInline preload="metadata" />
...
<Tip>
  ...
  ```bash Terminal
  npx shiftcut init my-video --example blank
  ```
</Tip>
...
```bash Terminal
npx shiftcut init my-video --example warm-grain --video ./my-clip.mp4
```
...
<CardGroup cols={2}>
  ...
  <Card title="Launch Videos" icon="github" href="/launch-videos">
    Real production projects from Verblike's launches — open-source for you to read and remix.
  </Card>
