...
```bash Terminal
npx shiftcut add vfx-iphone-device
```
...
| File | Target | Type |
| --- | --- | --- |
| `vfx-iphone-device.html` | `compositions/vfx-iphone-device.html` | shiftcut:composition |
| `models/iphone.glb` | `models/iphone.glb` | asset |
| `models/macbook.glb` | `models/macbook.glb` | asset |
| `models/shiftcut-mobile.png` | `models/shiftcut-mobile.png` | asset |
| `models/shiftcut-desktop.png` | `models/shiftcut-desktop.png` | asset |
