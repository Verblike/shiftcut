...
```bash Terminal
npx shiftcut add grid-pixelate-wipe
```
...
| File | Target | Type |
| --- | --- | --- |
| `grid-pixelate-wipe.html` | `compositions/components/grid-pixelate-wipe.html` | shiftcut:snippet |
