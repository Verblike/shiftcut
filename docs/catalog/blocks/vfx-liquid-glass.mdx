...
```bash Terminal
npx shiftcut add vfx-liquid-glass
```
...
| File | Target | Type |
| --- | --- | --- |
| `vfx-liquid-glass.html` | `compositions/vfx-liquid-glass.html` | shiftcut:composition |
