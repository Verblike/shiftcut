...
```bash Terminal
npx shiftcut add code-snippet-light-plus
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-light-plus.html` | `compositions/code-snippet-light-plus.html` | shiftcut:composition |
