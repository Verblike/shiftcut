...
// `readWebGlVendorInfoFromCanvas` lives in `@shiftcut/engine` (it's
...
// `@shiftcut/producer/distributed` keep working.
export { readWebGlVendorInfoFromCanvas } from "@shiftcut/engine";
