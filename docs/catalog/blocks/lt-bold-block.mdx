...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/lt-bold-block.mp4" poster="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/lt-bold-block.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx shiftcut add lt-bold-block
```
...
| File | Target | Type |
| --- | --- | --- |
| `lt-bold-block.html` | `compositions/lt-bold-block.html` | shiftcut:composition |
