 ...
 *
 * Fetches registry manifests and item files from a Shiftcut registry hosted
 ...
 *
 * `<type-dir>` comes from ITEM_TYPE_DIRS in @shiftcut/core.
 */
...
const CACHE_DIR = join(homedir(), ".shiftcut", "cache");
