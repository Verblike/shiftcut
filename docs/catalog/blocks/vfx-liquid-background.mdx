...
```bash Terminal
npx shiftcut add vfx-liquid-background
```
...
| File | Target | Type |
| --- | --- | --- |
| `vfx-liquid-background.html` | `compositions/vfx-liquid-background.html` | shiftcut:composition |
