...
```bash Terminal
npx shiftcut add code-particle-assemble
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-particle-assemble.html` | `compositions/code-particle-assemble.html` | shiftcut:composition |
