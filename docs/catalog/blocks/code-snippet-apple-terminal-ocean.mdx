...
```bash Terminal
npx shiftcut add code-snippet-apple-terminal-ocean
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-apple-terminal-ocean.html` | `compositions/code-snippet-apple-terminal-ocean.html` | shiftcut:composition |
