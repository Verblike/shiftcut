...
import { lintShiftCutHtml, lintMediaUrls } from "./shiftcutLinter.js";

afterEach(() => vi.unstubAllGlobals());

describe("lintShiftCutHtml — orchestrator", () => {
...
<body>
  ...
  it("attaches filePath to findings when option is set", async () => {
    ...
    const result = await lintShiftCutHtml(html, { filePath: "test.html" });
...
<html><body>
  ...
  <script>
    ...
    const result = await lintShiftCutHtml(html, { filePath: "compositions/my-comp.html" });
