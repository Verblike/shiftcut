...
import { extractGsapLabels } from "@shiftcut/core/gsap-parser-acorn";
import { stripEmbeddedRuntimeScripts } from "@shiftcut/core/compiler/html-document";
import { readClipTiming, type ClipTiming } from "@shiftcut/core/composition-contract";
import {
  readDeclaredDefaults,
  validateVariables,
  scanVariableUsage,
} from "@shiftcut/core/variables";
import type { CompositionVariable, VariableValidationIssue } from "@shiftcut/core/variables";
