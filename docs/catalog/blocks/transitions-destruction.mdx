...
```bash Terminal
npx shiftcut add transitions-destruction
```
...
| File | Target | Type |
| --- | --- | --- |
| `transitions-destruction.html` | `compositions/transitions-destruction.html` | shiftcut:composition |
