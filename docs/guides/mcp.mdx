...
<Note>
  **In beta.** Features and pricing may change. Found a bug or have feedback? [File an issue on GitHub](https://github.com/Vadagon/shiftcut/issues).
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Render is stuck or never completes">
    ...
    3. If the issue persists, file an issue at [github.com/Vadagon/shiftcut/issues](https://github.com/Vadagon/shiftcut/issues) including the `job_id` from `render_video`
  </Accordion>
...
For bugs or feature requests, file an issue at [github.com/Vadagon/shiftcut/issues](https://github.com/Vadagon/shiftcut/issues). Include:
...
[ShiftCut itself is open source](https://github.com/Vadagon/shiftcut) — the HTML composition format, CLI, renderer, and player. You can use ShiftCut locally without the MCP.
