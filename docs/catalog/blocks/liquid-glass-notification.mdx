...
```bash Terminal
npx shiftcut add liquid-glass-notification
```
...
| File | Target | Type |
| --- | --- | --- |
| `liquid-glass-notification.html` | `compositions/liquid-glass-notification.html` | shiftcut:composition |
