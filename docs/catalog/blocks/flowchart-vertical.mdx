...
```bash Terminal
npx shiftcut add flowchart-vertical
```
...
| File | Target | Type |
| --- | --- | --- |
| `flowchart-vertical.html` | `compositions/flowchart-vertical.html` | shiftcut:composition |
