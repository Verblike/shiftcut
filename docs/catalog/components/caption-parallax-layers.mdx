...
```bash Terminal
npx shiftcut add caption-parallax-layers
```
...
| File | Target | Type |
| --- | --- | --- |
| `caption-parallax-layers.html` | `compositions/components/caption-parallax-layers.html` | shiftcut:snippet |
