...
```bash Terminal
npx shiftcut add macos-tahoe-liquid-glass
```
...
| File | Target | Type |
| --- | --- | --- |
| `macos-tahoe-liquid-glass.html` | `compositions/macos-tahoe-liquid-glass.html` | shiftcut:composition |
| `models/macbook.glb` | `models/macbook.glb` | shiftcut:asset |
| `models/iphone.glb` | `models/iphone.glb` | shiftcut:asset |
