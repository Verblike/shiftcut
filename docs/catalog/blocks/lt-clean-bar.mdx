...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/lt-clean-bar.mp4" poster="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/lt-clean-bar.png" autoPlay muted loop playsInline />
...
| File | Target | Type |
| --- | --- | --- |
| `lt-clean-bar.html` | `compositions/lt-clean-bar.html` | shiftcut:composition |
