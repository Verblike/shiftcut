...
```bash Terminal
npx shiftcut add code-3d-extrude
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-3d-extrude.html` | `compositions/code-3d-extrude.html` | shiftcut:composition |
