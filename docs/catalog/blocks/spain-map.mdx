...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/spain-map.mp4" poster="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/spain-map.png" autoPlay muted loop playsInline />
...
| File | Target | Type |
| --- | --- | --- |
| `spain-map.html` | `compositions/spain-map.html` | shiftcut:composition |
