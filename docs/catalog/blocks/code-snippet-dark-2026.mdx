...
```bash Terminal
npx shiftcut add code-snippet-dark-2026
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-dark-2026.html` | `compositions/code-snippet-dark-2026.html` | shiftcut:composition |
