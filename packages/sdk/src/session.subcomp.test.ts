...
import { ensureHfIds } from "@shiftcut/core/hf-ids";
import { RUNTIME_BOOTSTRAP_ATTR } from "@shiftcut/core";
...
describe("serialize({ stripRuntime })", () => {
  ...
  it("re-exports RUNTIME_BOOTSTRAP_ATTR from @shiftcut/core, matching the marker generators stamp", async () => {
    expect(RUNTIME_BOOTSTRAP_ATTR).toBe("data-shiftcut-preview-runtime");
