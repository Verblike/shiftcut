...
```bash Terminal
npx shiftcut add caption-neon-accent
```
...
| File | Target | Type |
| --- | --- | --- |
| `caption-neon-accent.html` | `compositions/components/caption-neon-accent.html` | shiftcut:snippet |
