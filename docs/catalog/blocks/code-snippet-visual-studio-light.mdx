...
```bash Terminal
npx shiftcut add code-snippet-visual-studio-light
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-visual-studio-light.html` | `compositions/code-snippet-visual-studio-light.html` | shiftcut:composition |
| `background.jpeg` | `assets/background.jpeg` | shiftcut:asset |
