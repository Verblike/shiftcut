...
} from "@shiftcut/parsers/slideshow";
  ...
  (ctx) => {
    ...
    try {
      ...
      findings.push({
        ...
        fixHint:
          'Ensure the <script type="application/shiftcut-slideshow+json"> block contains valid JSON matching the SlideshowManifest schema.',
      });
      return findings;
    }
