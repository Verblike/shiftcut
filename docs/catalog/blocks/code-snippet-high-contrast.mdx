...
```bash Terminal
npx shiftcut add code-snippet-high-contrast
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-high-contrast.html` | `compositions/code-snippet-high-contrast.html` | shiftcut:composition |
