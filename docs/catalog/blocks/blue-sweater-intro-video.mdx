...
```bash Terminal
npx shiftcut add blue-sweater-intro-video
```
...
| File | Target | Type |
| --- | --- | --- |
| `blue-sweater-intro-video.html` | `compositions/blue-sweater-intro-video.html` | shiftcut:composition |
| `assets/joe-sai-avatar.png` | `assets/joe-sai-avatar.png` | shiftcut:asset |
| `assets/sfx/integrated-melodic-tech-mix.wav` | `assets/sfx/integrated-melodic-tech-mix.wav` | shiftcut:asset |
