...
```bash Terminal
npx shiftcut add code-snippet-apple-terminal-clear-light
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-apple-terminal-clear-light.html` | `compositions/code-snippet-apple-terminal-clear-light.html` | shiftcut:composition |
