...
import { injectScriptsIntoHtml, stripEmbeddedRuntimeScripts } from "@shiftcut/core/compiler";
...
import { ensureHfIds } from "@shiftcut/parsers/hf-ids";
...
const PROJECT_SIGNATURE_META = "shiftcut-project-signature";
