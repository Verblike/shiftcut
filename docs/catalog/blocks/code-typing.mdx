...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/code-typing.mp4" poster="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/code-typing.png" autoPlay muted loop playsInline />
...
| File | Target | Type |
| --- | --- | --- |
| `code-typing.html` | `compositions/code-typing.html` | shiftcut:composition |
