...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/code-highlight.mp4" poster="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/blocks/code-highlight.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx shiftcut add code-highlight
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-highlight.html` | `compositions/code-highlight.html` | shiftcut:composition |
