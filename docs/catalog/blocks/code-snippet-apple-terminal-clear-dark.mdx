...
```bash Terminal
npx shiftcut add code-snippet-apple-terminal-clear-dark
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-apple-terminal-clear-dark.html` | `compositions/code-snippet-apple-terminal-clear-dark.html` | shiftcut:composition |
