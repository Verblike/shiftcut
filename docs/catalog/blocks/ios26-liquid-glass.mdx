...
```bash Terminal
npx shiftcut add ios26-liquid-glass
```
...
| File | Target | Type |
| --- | --- | --- |
| `ios26-liquid-glass.html` | `compositions/ios26-liquid-glass.html` | shiftcut:composition |
| `models/iphone.glb` | `models/iphone.glb` | shiftcut:asset |
| `lib/liquid-glass.iife.js` | `lib/liquid-glass.iife.js` | shiftcut:asset |
