...
// Capstone: media-use must actually OWN each shiftcut media weakness. This
...
test("weakness: scattered audio engine → consolidated under media-use (shiftcut-media gone)", () => {
