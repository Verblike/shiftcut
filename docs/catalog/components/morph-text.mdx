...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.verblike.ai/shiftcut-oss/docs/images/catalog/components/morph-text.mp4" autoPlay muted loop playsInline />
...
| File | Target | Type |
| --- | --- | --- |
| `morph-text.html` | `compositions/components/morph-text.html` | shiftcut:snippet |
