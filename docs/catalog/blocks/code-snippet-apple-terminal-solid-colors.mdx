...
```bash Terminal
npx shiftcut add code-snippet-apple-terminal-solid-colors
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-apple-terminal-solid-colors.html` | `compositions/code-snippet-apple-terminal-solid-colors.html` | shiftcut:composition |
