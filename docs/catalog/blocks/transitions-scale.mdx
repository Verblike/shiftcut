...
```bash Terminal
npx shiftcut add transitions-scale
```
...
| File | Target | Type |
| --- | --- | --- |
| `transitions-scale.html` | `compositions/transitions-scale.html` | shiftcut:composition |
