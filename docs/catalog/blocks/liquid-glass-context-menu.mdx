...
```bash Terminal
npx shiftcut add liquid-glass-context-menu
```
...
| File | Target | Type |
| --- | --- | --- |
| `liquid-glass-context-menu.html` | `compositions/liquid-glass-context-menu.html` | shiftcut:composition |
