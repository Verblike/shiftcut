...
```bash Terminal
npx shiftcut add transitions-radial
```
...
| File | Target | Type |
| --- | --- | --- |
| `transitions-radial.html` | `compositions/transitions-radial.html` | shiftcut:composition |
