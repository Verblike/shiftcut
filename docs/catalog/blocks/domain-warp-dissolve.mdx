...
```bash Terminal
npx shiftcut add domain-warp-dissolve
```
...
| File | Target | Type |
| --- | --- | --- |
| `domain-warp-dissolve.html` | `compositions/domain-warp-dissolve.html` | shiftcut:composition |
