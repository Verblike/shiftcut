...
```bash Terminal
npx shiftcut add apple-money-count
```
...
| File | Target | Type |
| --- | --- | --- |
| `apple-money-count.html` | `compositions/apple-money-count.html` | shiftcut:composition |
| `assets/sfx-production.wav` | `assets/sfx-production.wav` | shiftcut:asset |
