...
```bash Terminal
npx shiftcut add transitions-push
```
...
| File | Target | Type |
| --- | --- | --- |
| `transitions-push.html` | `compositions/transitions-push.html` | shiftcut:composition |
